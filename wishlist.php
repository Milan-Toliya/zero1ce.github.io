...
<body>
  ...
  <?php include 'navlog.php'; ?>
      ...
      <div class="container">
        <div>
           <h3 style="border-radius: .25rem .25rem 0rem 0rem; margin-top: 80px; margin-bottom: 0px; background-color: #6c757d; text-align: center; color: white;">Your Wishlist
        ...
        <div style="margin-bottom: 20px; padding-top: 15px; padding-bottom: 15px; border: solid 1px #e1e2e3; box-shadow: 0px 2px 3px 1px #e1e2e3; border-radius: 0rem 0rem .25rem .25rem;" class="container card">
          ...
          <div class="row">
          <?php
            $resultset = mysqli_query($conn, "SELECT * FROM wishcart where userID = '$userID' " );
